    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NormType", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Information_Designation_ModelId = table.Column<Guid>(type: "TEXT", nullable: true),
                    Information_Designation_VariantId = table.Column<Guid>(type: "TEXT", nullable: true),
                    Information_Designation_TypeId = table.Column<Guid>(type: "TEXT", nullable: true),
                    Information_ColorId = table.Column<Guid>(type: "TEXT", nullable: true),
                    Information_NormId = table.Column<Guid>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Vehicles_NormType_Information_NormId",
                        column: x => x.Information_NormId,
                        principalTable: "NormType",
                        principalColumn: "Id");
                    table.ForeignKey(
